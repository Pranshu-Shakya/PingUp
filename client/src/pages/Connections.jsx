									...
									<div className="flex max-sm:flex-col gap-2 mt-4">
										...
										{currentTab === "Following" && (
											<button
												...
												className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 cursor-pointer transition"
											>
												Unfollow
											</button>
										)}
										...
										{currentTab === "Connections" && (
											<button
												...
												className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-slate-800 active:scale-95 cursor-pointer transition flex items-center justify-center gap-1"
											>
